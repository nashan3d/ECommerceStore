...
namespace ECommerceStore.IDP.Web
{
    public class SeedData
    {
        public static void EnsureSeedData(string connectionString)
        {
            ...
            EnsureRoleCreated(scope);
        }

        private static void EnsureRoleCreated(IServiceScope scope)
        {
        ...
        private static void EnsureUsers(IServiceScope scope)
        {
            ...
            if (angella == null)
            {
                ...
                if (!userMgr.IsInRoleAsync(angella, "Admin").Result)
                {
                    _ = userMgr.AddToRoleAsync(angella, "Admin").Result;
                }
            }
        }
